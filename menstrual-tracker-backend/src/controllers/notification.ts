...
const createMenstrualNotification = async (userId: string, message: string) => {
...
//       // Create notifications based on the menstrual data
//       // 1. Notification for expected next menstrual date
//       const nextDateMessage = `Hello, your next menstrual cycle is expected on ${expectedNextDate.toDateString()}.`;
//       await createMenstrualNotification(userId, nextDateMessage);

//       // 2. Notification for reminder a day before the next menstrual date
//       const reminderDate = new Date(expectedNextDate);
//       reminderDate.setDate(reminderDate.getDate() - 1); // Subtract 1 day for the reminder
//       const reminderMessage = `Hello, tomorrow is the expected start of your menstrual cycle.`;
//       await createMenstrualNotification(userId, reminderMessage);
//     }
