...
// @access  Private
export const recordMenstrualData = async (req: Request, res: Response) => {
  try {
...
// @access  Private
export const getMenstrualData = async (req: Request, res: Response) => {
  try {
    const userId = req.user?.id;
...
// @access  Private
export const deleteMenstrualData = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const userId = req.user?.id;
